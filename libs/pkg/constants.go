...
const (
	...
	BUCKET_URL                  = "https://orya-agent.s3.us-east-1.amazonaws.com"
	...
	URL_DATADOG_GITHUB_VERSIONS = "https://api.github.com/repos/DataDog/datadog-agent/releases"

	ORYA_FILE_AGENT_VERSIONS_NAME = "index_os_instance.json"
)

...
func (d *DatadogAdapter) IsActive() (bool, error) {
	d.logger.Debug("is active", "trace", "agent-os-instance.datadog_adapter.IsActive")
...
func (d *DatadogAdapter) InstallAgent(ddSite, ddApiKey, version string) error {
	d.logger.Debug("install agent", "trace", "agent-os-instance.datadog_adapter.InstallAgent", "ddSite", ddSite, "ddApiKey", ddApiKey, "version", version)
...
func (d *DatadogAdapter) GetApmEnvVarsTracingLibrary(envs []dto.DatadogEnvVars) (string, string, string) {
	d.logger.Debug("get apm envs vars tracing library", "trace", "agent-os-instance.datadog_adapter.GetApmEnvVarsTracingLibrary", "envs", envs)
...
func (d *DatadogAdapter) InstallAgentApmTracingLibrary(languageName, pathTracer, version string) error {
	d.logger.Debug("install agent apm tracing library", "trace", "agent-os-instance.datadog_adapter.InstallAgentApmTracingLibrary", "languageName", languageName, "pathTracer", pathTracer, "version", version)
...
func (d *DatadogAdapter) UninstallAgent() error {
	d.logger.Debug("uninstall agent", "trace", "agent-os-instance.datadog_adapter.UninstallAgent")
...
func (d *DatadogAdapter) DiscoverDatadogConfigPath() (string, error) {
	d.logger.Debug("discover datadog config path", "trace", "agent-os-instance.datadog_adapter.DiscoverDatadogConfigPath")
...
func (d *DatadogAdapter) DecodeBase64(base64Content string) ([]byte, error) {
	d.logger.Debug("decode base64", "trace", "agent-os-instance.datadog_adapter.DecodeBase64", "base64Content", base64Content)
...
func (d *DatadogAdapter) DatadogAddPermitionGroupFilePath(filePath string) error {
	d.logger.Debug("datadog add permition group file path", "trace", "agent-os-instance.datadog_adapter.DatadogAddPermitionGroupFilePath")
...
func (d *DatadogAdapter) DatadogAddPermitionUser() error {
	d.logger.Debug("datadog add permition user", "trace", "agent-os-instance.datadog_adapter.DatadogAddPermitionUser")
...
func (d *DatadogAdapter) BackupConfigFileDatadog(filePath string, content []byte) error {
	d.logger.Debug("backup config file datadog", "trace", "agent-os-instance.datadog_adapter.BackupConfigFileDatadog", "filePath", filePath, "content", string(content))
...
func (d *DatadogAdapter) UpdateConfigFileDatadog(filePath string) error {
	d.logger.Debug("update config file datadog", "trace", "agent-os-instance.datadog_adapter.UpdateConfigFileDatadog", "filePath", filePath)
...
func (d *DatadogAdapter) GetVersion() (string, error) {
	d.logger.Debug("get version", "trace", "agent-os-instance.datadog_adapter.GetVersion")
...
func (d *DatadogAdapter) GetLatestVersion() (string, error) {
	d.logger.Debug("get latest version", "trace", "agent-os-instance.datadog_adapter.GetLatestVersion")
...
func (d *DatadogAdapter) UpdateVersion(version string) error {
	d.logger.Debug("update version", "trace", "agent-os-instance.datadog_adapter.UpdateVersion", "version", version)
...
func (d *DatadogAdapter) RollbackVersion(version string) error {
	d.logger.Debug("rollback version", "trace", "agent-os-instance.datadog_adapter.RollbackVersion", "version", version)
...
func (d *DatadogAdapter) DPKGConfigure() error {
	d.logger.Debug("dpkg configure", "trace", "agent-os-instance.datadog_adapter.DPKGConfigure")
